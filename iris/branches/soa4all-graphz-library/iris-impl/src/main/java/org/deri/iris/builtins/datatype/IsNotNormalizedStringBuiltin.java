 ...
 * @author Adrian Marte
 */
public class IsNotNormalizedStringBuiltin extends BooleanBuiltin {

	/** The predicate defining this built-in. */
	public static final IPredicate PREDICATE = BASIC.createPredicate(
			"IS_NOT_NORMALIZEDSTRING", 1);
	 ...
	 */
	public IsNotNormalizedStringBuiltin(ITerm... terms) {
		super(PREDICATE, terms);
	}

	protected boolean computeResult(ITerm[] terms) {
		return !IsNormalizedStringBuiltin.isNormalizedString(terms[0]);
	}
