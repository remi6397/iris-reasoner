...
import at.sti2.streamingiris.ConfigurationThreadLocalStorage;
...
import at.sti2.streamingiris.builtins.datatype.ToDayTimeDurationBuiltin;
import at.sti2.streamingiris.builtins.datatype.ToDoubleBuiltin;
import at.sti2.streamingiris.builtins.datatype.ToFloatBuiltin;
import at.sti2.streamingiris.builtins.datatype.ToYearMonthDurationBuiltin;
import at.sti2.streamingiris.factory.Factory;
import at.sti2.streamingiris.terms.concrete.XmlDurationWorkAroundHelper;
...
public class BuiltinHelper {
	 ...
	 * tuples.
	 */
	public static final ITuple EMPTY_TUPLE = at.sti2.streamingiris.factory.Factory.BASIC
	...
	private static ITime createTime(final XMLGregorianCalendar dt) {
		...
		return CONCRETE
				.createTime(dt.getHour(), dt.getMinute(), dt.getSecond(),
						dt.getMillisecond(), tzHours(dt), tzMinutes(dt));
	}
