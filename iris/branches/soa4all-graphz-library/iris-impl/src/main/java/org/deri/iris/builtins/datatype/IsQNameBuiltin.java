 ...
 * @author Adrian Marte
 */
public class IsQNameBuiltin extends BooleanBuiltin {
	 ...
	 */
	public IsQNameBuiltin(ITerm... terms) {
		super(PREDICATE, terms);
	}

	protected boolean computeResult(ITerm[] terms) {
		return isQName(terms[0]);
	}
	
	public static boolean isQName(ITerm term) {
		return term instanceof IQName;
	}
