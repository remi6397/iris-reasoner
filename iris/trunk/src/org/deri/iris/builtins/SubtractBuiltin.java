 ...
 * </p>
 * <p>
 * $Id: SubtractBuiltin.java,v 1.1 2006-09-28 11:30:50 richardpoettler Exp $
 * </p>
 * 
 * @author richi
...
public class SubtractBuiltin extends AbstractBuiltin {
	 ...
	 */
	SubtractBuiltin(final ITerm t0, final ITerm t1) {
	 ...
	 * {@code ITerm.subtract(ITerm)} method for evaluation and stores the
	 * result at the index 2.
	 * </p>
	 * 
	 * @return {@code true} if the evalueation succeeded
	 * @throws OperationNotSupportedException
	 *             if the first term doesn't support the {@code subtract(ITerm)}
	 *             method at all
	 * @throws IllegalArgumentException
	 *             if the first term doesn't support the {@code subtract(ITerm)}
	 *             method with the type of the second term
	 * @see ITerm#subtract(ITerm)
	 */
	public boolean evaluate() {
		setTerm(2, getTerm(0).subtract(getTerm(1)));
		return true;
	}
}
