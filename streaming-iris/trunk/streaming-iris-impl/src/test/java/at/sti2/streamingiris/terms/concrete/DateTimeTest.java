...
public class DateTimeTest extends TestCase {
	...
	public void testFloatingPointSeconds() {
		...
		assertEquals("Something wrong with getHour", HOUR, dt.getHour());
		assertEquals("Something wrong with getMinute", MINUTE, dt.getMinute());
		assertEquals("Something wrong with getSecond", seconds,
				dt.getDecimalSecond());
	...
	public static Test suite() {
		return new TestSuite(DateTimeTest.class,
				DateTimeTest.class.getSimpleName());
	}
	...
	public void testCorrectMonthBehaviour() {
		...
		assertTrue(y2000m1d1 + " must be smaller than " + y2000m12d1,
				y2000m1d1.compareTo(y2000m12d1) < 0);
	}
}
