 ...
 * @date 13.06.2007 15:44:38
 */
public class GeneralProjection implements IProjection {
	...
	/**
	 * Outnput relation, i.e., input relation which is projected out w.r.t the
	 * projection pattern
	 */
	private IMixedDatatypeRelation projectionRelation = null;

	/**
	 * <p>
	 * Constructs a projection operator.
	 * </p>
	 * @param relation	Input relation.
	 * @param pattern	Projection pattern.
	 */
	GeneralProjection(final IMixedDatatypeRelation relation, final int[] pattern) {
		...
		projectionRelation = RELATION.getMixedRelation(this.arity);
	}
	...
	public IMixedDatatypeRelation project() {
		...
		while (iterator.hasNext()) {
			tuple = projectTuple(iterator.next());
