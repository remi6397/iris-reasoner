...
/**
 * <p>
 * Builtin to compute the quotient of two terms.
 * </p>
 * <p>
 * $Id: DivideBuiltin.java,v 1.1 2006-09-28 11:30:50 richardpoettler Exp $
 * </p>
 * 
 * @author richi
...
public class DivideBuiltin extends AbstractBuiltin {
	 ...
	 */
	DivideBuiltin(final ITerm t0, final ITerm t1) {
	 ...
	 * {@code ITerm.divide(ITerm)} method for evaluation and stores the
	 * result at the index 2.
	 * </p>
	 * 
	 * @return {@code true} if the evalueation succeeded
	 * @throws OperationNotSupportedException
	 *             if the first term doesn't support the {@code divide(ITerm)}
	 *             method at all
	 * @throws IllegalArgumentException
	 *             if the first term doesn't support the {@code divide(ITerm)}
	 *             method with the type of the second term
	 * @see ITerm#divide(ITerm)
	 */
	public boolean evaluate() {
		setTerm(2, getTerm(0).divide(getTerm(1)));
		return true;
	}
}
