 ...
 * </p>
 */
public class YearMonthDurationLessEqualBuiltin extends LessEqualBuiltin {

	/** The predicate defining this built-in. */
	private static final IPredicate PREDICATE = BASIC.createPredicate(
			"YEARMONTHDURATION_LESS_EQUAL", 2);

	public YearMonthDurationLessEqualBuiltin(ITerm... terms) {
