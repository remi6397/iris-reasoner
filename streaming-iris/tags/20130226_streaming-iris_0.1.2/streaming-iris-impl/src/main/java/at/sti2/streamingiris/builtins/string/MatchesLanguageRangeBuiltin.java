...
public class MatchesLanguageRangeBuiltin extends BooleanBuiltin {
	 ...
	 * 
	 * @param terms
	 *            An array of terms, where the term at the first position is the
	 *            PlainLiteral and the term at the second position is the
	 *            language range.
	 * @throws NullPointerException
	 *             If <code>terms</code> is <code>null</code>.
	 * @throws NullPointerException
	 *             If the term array contains a <code>null</code> value.
	 * @throws IllegalArgumentException
	 *             If the number of terms is not 2.
	 */
