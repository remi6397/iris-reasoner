...
public class StringSubstringAfterBuiltin extends AbstractBuiltin {
	 ...
	 */
	public StringSubstringAfterBuiltin(final ITerm haystack, final ITerm needle) {
	 ...
	 *             if one of the terms is {@code null}
	 */
	public StringSubstringAfterBuiltin(final ITerm haystack,
