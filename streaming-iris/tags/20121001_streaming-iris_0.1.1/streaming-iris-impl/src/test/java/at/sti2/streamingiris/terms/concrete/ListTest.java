...
public class ListTest extends AbstractConcreteTermTest {
	...
	protected IConcreteTerm createBasic() {
		return new at.sti2.streamingiris.terms.concrete.List(new IntTerm(2),
				new IntTerm(3));
	}
	...
	public void testCompareTo2() {
		at.sti2.streamingiris.terms.concrete.List list_one = new at.sti2.streamingiris.terms.concrete.List(
				new IntTerm(1), new IntTerm(2));
		at.sti2.streamingiris.terms.concrete.List list_two = new at.sti2.streamingiris.terms.concrete.List(
				new IntTerm(2), new IntTerm(3));
		at.sti2.streamingiris.terms.concrete.List list_three = new at.sti2.streamingiris.terms.concrete.List(
		...
		at.sti2.streamingiris.terms.concrete.List list_short = new at.sti2.streamingiris.terms.concrete.List(
	...
	public void testListEquals2() {
		...
		at.sti2.streamingiris.terms.concrete.List list_three = new at.sti2.streamingiris.terms.concrete.List(
				new IntTerm(1), new IntTerm(2), new IntTerm(3));
		at.sti2.streamingiris.terms.concrete.List list_four = new at.sti2.streamingiris.terms.concrete.List(
				new IntTerm(2), list_one, new IntTerm(3));
