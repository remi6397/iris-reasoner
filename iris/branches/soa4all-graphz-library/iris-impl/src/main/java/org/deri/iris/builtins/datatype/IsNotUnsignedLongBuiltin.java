 ...
 * @author Adrian Marte
 */
public class IsNotUnsignedLongBuiltin extends BooleanBuiltin {

	/** The predicate defining this built-in. */
	public static final IPredicate PREDICATE = BASIC.createPredicate(
			"IS_NOT_UNSIGNEDLONG", 1);
	 ...
	 */
	public IsNotUnsignedLongBuiltin(ITerm... terms) {
		super(PREDICATE, terms);
	}

	protected boolean computeResult(ITerm[] terms) {
		return !IsUnsignedLongBuiltin.isUnsignedLong(terms[0]);
	}
