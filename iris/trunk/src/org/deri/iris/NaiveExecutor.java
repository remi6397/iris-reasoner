...
/**
 * <p>
 * Executes a program using naive evaluation.
 * This is temporary until we have re-designed the use-case semantics of IRIS.
 * </p>
 */
public class NaiveExecutor implements IExecutor {
	 ...
	 */
	public NaiveExecutor(final IProgram p, final IExpressionEvaluator m) {
		if (p == null || m == null) {
