 ...
 * </p>
 * <p>
 * $Id: TermHelper.java,v 1.1 2006-09-27 12:34:35 richardpoettler Exp $
 * </p>
 * 
 * @author richi
 * @version $Revision: 1.1 $
 * @date $Date: 2006-09-27 12:34:35 $
 */
class TermHelper {
	private TermHelper() {
		// prevent subclassing
	...
	/**
	 * Returns the int value from a <code>INumericTerm</code> <b>This
	 * method assumes that only numbers are stored in <code>INumericTerm</code>.</b>
	 * 
	 * @param n
	 *            the term
