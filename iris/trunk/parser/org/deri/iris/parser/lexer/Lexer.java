...
public class Lexer
{
    ...
    Token new13(@SuppressWarnings("hiding") int line, @SuppressWarnings("hiding") int pos) { return new TTEq(line, pos); }
    Token new14(@SuppressWarnings("hiding") int line, @SuppressWarnings("hiding") int pos) { return new TTNeq(line, pos); }
...
/*  {
        { // INITIAL
            {{9, 9, 1}, {10, 10, 2}, {13, 13, 3}, {32, 32, 4}, {33, 33, 5}, {39, 39, 6}, {40, 40, 7}, {41, 41, 8}, {44, 44, 9}, {45, 45, 10}, {46, 46, 11}, {47, 47, 12}, {58, 58, 13}, {61, 61, 14}, {63, 63, 15}, {65, 90, 16}, {97, 97, 17}, {98, 109, 18}, {110, 110, 19}, {111, 122, 18}, },
            {{9, 32, -2}, },
            {{9, 32, -2}, },
            {{9, 9, 1}, {10, 10, 20}, {13, 32, -2}, },
            {{9, 32, -2}, },
            {{61, 61, 21}, },
            {{0, 38, 22}, {39, 39, 23}, {40, 91, 22}, {92, 92, 24}, {93, 65535, 22}, },
            {},
            {},
            {},
            {},
            ...
            {{45, 45, 27}, },
            {},
            {{45, 45, 28}, {65, 90, 29}, {97, 122, 30}, },
            {{65, 90, 16}, {97, 122, 18}, },
            {{65, 90, 16}, {97, 109, 18}, {110, 110, 31}, {111, 122, 18}, },
            {{65, 122, -18}, },
            {{65, 90, 16}, {97, 97, 32}, {98, 110, 18}, {111, 111, 33}, {112, 122, 18}, },
            {{9, 32, -2}, },
            {},
            {{0, 65535, -8}, },
            {},
            {{0, 38, 22}, {39, 39, 34}, {40, 65535, -8}, },
            {{0, 41, 35}, {42, 42, 36}, {43, 46, 35}, {47, 47, 37}, {48, 65535, 35}, },
            {{0, 9, 38}, {10, 10, 39}, {11, 12, 38}, {13, 13, 40}, {14, 65535, 38}, },
            {},
            {},
            {{65, 122, -17}, },
            {{65, 122, -17}, },
            {{65, 90, 16}, {97, 99, 18}, {100, 100, 41}, {101, 122, 18}, },
            {{65, 90, 16}, {97, 101, 18}, {102, 102, 42}, {103, 122, 18}, },
            {{65, 90, 16}, {97, 115, 18}, {116, 116, 43}, {117, 122, 18}, },
            {{0, 65535, -8}, },
            {{0, 46, -27}, {47, 47, 44}, {48, 65535, 35}, },
            {{0, 46, -27}, {47, 47, 45}, {48, 65535, 35}, },
            {{47, 47, 46}, },
            {{0, 65535, -28}, },
            {},
            {{10, 10, 47}, },
...
/*  {
        // INITIAL
        {-1, 0, 0, 0, 0, 5, -1, 7, 8, 6, 5, 2, -1, -1, 13, -1, 11, 11, 11, 11, 0, 14, -1, 11, -1, -1, -1, 3, 10, 9, 9, 11, 11, 11, 11, -1, -1, -1, -1, 1, 1, 4, 5, 5, -1, 1, -1, 1, },
