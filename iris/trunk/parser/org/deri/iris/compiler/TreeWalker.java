 ...
 * </p>
 * <p>
 * $Id: TreeWalker.java,v 1.18 2007-08-30 15:47:34 poettler_ric Exp $
 * </p>
...
public class TreeWalker extends DepthFirstAdapter {
	...
	if (builtinClass == null) { // this predicate is not a builtin
		...
		try {
			...
			LOGGER.error("Couldn't get the constructor for: " + builtinClass);
			throw new IllegalArgumentException(e);
		} catch (InstantiationException e) {
			LOGGER.error("Couldn't create the instance: " + builtinClass, e);
			throw new IllegalArgumentException(e);
	...
	public void outADurationTerm(final ADurationTerm d) {
		Integer[] params = transfromIntList(d.getIntlist());
		if (params.length != 4) {
			throw new IllegalArgumentException("The number of integers in a duration must be 4, but was " + 
					params.length + ": " + Arrays.toString(params));
		}
		terms.add(CONCRETE.createDuration(params[0], params[1], params[2], params[3]));
	}
