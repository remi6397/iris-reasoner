 ...
 * </p>
 * <p>
 * where q is a positive literal (the head), and p1, p2,...,pn is a conjunction
 * of several literals (the body). Only safe rules are supported. A rule is safe
 * if its every variable occurs in one of its positive, non built-in, atoms of
 * the body.
 * </p>
 * <p>
...
public interface IRule {
	...
	/**
	 * <p>
	 * A rule is rectified if its head has the same form as heads of the other
	 * rules from the program, e.g. p(X1,...,Xk) for variables X1,...,Xk.
	 * </p>
	 * <p>
