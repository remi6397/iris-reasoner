...
public class NotExactEqualBuiltinTest extends TestCase {
	...
	public void testEvaluation() throws Exception {
		...
		assertNotNull(
				"5.0f should be not exactly equal to 5.0d",
		...
		assertNotNull(
				"5 should be not exactly equal to a",
