...
import org.deri.mins.parser.lexer.Lexer;
import org.deri.mins.parser.lexer.LexerException;
import org.deri.mins.parser.node.Node;
import org.deri.mins.parser.parser.Parser;
import org.deri.mins.parser.parser.ParserException;
 ...
 * $Source: /tmp/iris-cvsbackup/iris/parser/org/deri/mins/compiler/ParserImpl.java,v $,
 * </pre>
 *
 ...
 */
public class ParserImpl implements org.deri.mins.compiler.Parser {
     
    public SymbolMap sm = new SymbolMap();
    
    /* (non-Javadoc)
     * @see org.deri.mins.compiler.Parser#compileKB(java.lang.StringBuffer, org.deri.mins.RuleSet)
     */
    ...
    /* (non-Javadoc)
     * @see org.deri.mins.compiler.Parser#setSymbolMap(org.deri.mins.compiler.SymbolMap)
     */
    ...
    /* (non-Javadoc)
     * @see org.deri.mins.compiler.Parser#getSymbolMap()
     */
    ...
    /* (non-Javadoc)
     * @see org.deri.mins.compiler.Parser#compileRule(java.lang.String)
     */
    ...
    /* (non-Javadoc)
     * @see org.deri.mins.compiler.Parser#compileFact(java.lang.String)
     */
