...
public class List implements IList {
	...
	public List(at.sti2.streamingiris.terms.concrete.List list) {
		items = new ArrayList<IConcreteTerm>();
	...
	@Override
	public at.sti2.streamingiris.terms.concrete.List subList(int fromIndex, int toIndex) {
		return new at.sti2.streamingiris.terms.concrete.List(items.subList(fromIndex,
				toIndex));
	}
