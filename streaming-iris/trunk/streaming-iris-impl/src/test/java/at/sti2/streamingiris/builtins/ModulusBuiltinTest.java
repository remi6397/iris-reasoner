...
public class ModulusBuiltinTest extends TestCase {
	...
	public static Test suite() {
		return new TestSuite(ModulusBuiltinTest.class,
				ModulusBuiltinTest.class.getSimpleName());
	}
