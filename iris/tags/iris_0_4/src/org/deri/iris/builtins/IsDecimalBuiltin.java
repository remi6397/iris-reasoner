 ...
 * </p>
 * <p>
 * $Id: IsDecimalBuiltin.java,v 1.1 2007-07-13 09:12:44 poettler_ric Exp $
 * </p>
 * @author Richard Pöttler (richard dot poettler at deri dot at)
 * @version $Revision: 1.1 $
 * @since 0.4
 */
public class IsDecimalBuiltin extends AbstractBuiltin {

	/** The predicate defining this builtin. */
	private static final IPredicate PREDICATE = 
		org.deri.iris.factory.Factory.BASIC.createPredicate("ISDECIMAL", 1);
	...
	public ITuple evaluate(final ITuple t) {
		...
		if (BuiltinHelper.determineUnground(Arrays.asList(complete)).length == 0) {
			return (complete[0] instanceof IDecimalTerm) ? BuiltinHelper.EMPTY_TUPLE : null;
		}
