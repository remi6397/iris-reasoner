 ...
 * </p>
 */
public class SubtractDayTimeDurationFromDateTimeBuiltin extends SubtractBuiltin {

	/** The predicate defining this built-in. */
	private static final IPredicate PREDICATE = BASIC.createPredicate(
			"SUBTRACT_DAYTIMEDURATION_FROM_DATETIME", 3);
	 ...
	 *             3.
	 */
	public SubtractDayTimeDurationFromDateTimeBuiltin(ITerm... terms) {
