...
import org.deri.iris.api.evaluation_old.IResultSet;
 ...
 */
public class EvaluationFactory implements IEvaluationFactory {

	private static final IEvaluationFactory INSTANCE = new EvaluationFactory();
	 ...
	 */
	public static IEvaluationFactory getInstance() {
		return INSTANCE;
	}
