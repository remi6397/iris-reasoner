...
public class ToDateTimeStampBuiltinTest extends TestCase {
	...
	public void testDate() throws EvaluationException {
		equals(CONCRETE.createDateTimeStamp(2009, 04, 27, 0, 0, 0, 0, 0),
				CONCRETE.createDate(2009, 04, 27));
		equals(CONCRETE.createDateTimeStamp(2009, 04, 27, 0, 0, 0, 5, 0),
				CONCRETE.createDate(2009, 04, 27, 5, 0));
	}
