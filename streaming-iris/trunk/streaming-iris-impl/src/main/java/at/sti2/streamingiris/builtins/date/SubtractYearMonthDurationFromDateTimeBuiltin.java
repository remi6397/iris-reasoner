 ...
 * </p>
 */
public class SubtractYearMonthDurationFromDateTimeBuiltin extends
		SubtractBuiltin {

	/** The predicate defining this built-in. */
	private static final IPredicate PREDICATE = BASIC.createPredicate(
			"SUBTRACT_YEARMONTHDURATION_FROM_DATETIME", 3);
	 ...
	 */
	public SubtractYearMonthDurationFromDateTimeBuiltin(ITerm... terms) {
