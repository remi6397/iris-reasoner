 ...
 */
public class GeneralDBProgramTest extends TestCase {
	
	private static IProgramFactory FACTORY1=ProgramFactory.getInstance();
	private static IProgramFactory FACTORY2=ProgramFactory.getInstance();
	...
	public static void main(String[] args) {
		junit.textui.TestRunner.run(GeneralDBProgramTest.class);
	}
	
	public static junit.framework.Test suite() {
		Test test = new junit.extensions.TestSetup(new TestSuite(
				GeneralDBProgramTest.class)) {
			long t0_start = System.currentTimeMillis();
			protected void setUp() throws Exception {
		    	
		    	Map conf1=new Hashtable();
				conf1.put("DB_URL", "jdbc:derby:reasonerTest1;create=true");
				conf1.put("DB_CLASS", "org.apache.derby.jdbc.EmbeddedDriver");
				((ProgramFactory)FACTORY1).setDbConfigurationFile(conf1);
				Map conf2=new Hashtable();
				conf2.put("DB_URL", "jdbc:derby:reasonerTest2;create=true");
				conf2.put("DB_CLASS", "org.apache.derby.jdbc.EmbeddedDriver");
				((ProgramFactory)FACTORY2).setDbConfigurationFile(conf2);
             }
            ...
            protected void tearDown() throws Exception {
                ...
                try {
                   DriverManager.getConnection("jdbc:derby:reasonerTest1;shutdown=true");
                   DriverManager.getConnection("jdbc:derby:reasonerTest2;shutdown=true");
	...
	public Map<IPredicate, IMixedDatatypeRelation> evaluateProgram(String program) 
		throws Exception{
    	IProgram p = FACTORY1.createProgram();
    	p.resetProgram();
	...
	public void testProgram(Map<IPredicate, IMixedDatatypeRelation> res1, String res0)
		...
		IProgram p = FACTORY2.createProgram(f, r, q);
    	Parser.parse(res0, p);
