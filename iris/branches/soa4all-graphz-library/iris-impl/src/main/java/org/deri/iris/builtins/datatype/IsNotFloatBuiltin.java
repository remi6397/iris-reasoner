 ...
 */
public class IsNotFloatBuiltin extends BooleanBuiltin {
	/**
	 * Constructor.
	 * 
	 * @param t The list of terms. Must always be of length 1 in this case.
	 */
	public IsNotFloatBuiltin(final ITerm... t) {
		super(PREDICATE, t);
	}

	protected boolean computeResult(ITerm[] terms) {
		return !IsFloatBuiltin.isFloat(terms[0]);
	}

	/** The predicate defining this built-in. */
	private static final IPredicate PREDICATE = org.deri.iris.factory.Factory.BASIC
			.createPredicate("IS_NOT_FLOAT", 1);
}
