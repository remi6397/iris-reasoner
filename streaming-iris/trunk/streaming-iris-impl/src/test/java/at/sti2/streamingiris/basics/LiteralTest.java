...
public class LiteralTest extends TestCase {
	...
	private static final IAtom ATOM = BASIC.createAtom(PREDICATE,
			BASIC.createTuple(TUPLE));

	public static Test suite() {
		return new TestSuite(LiteralTest.class,
				LiteralTest.class.getSimpleName());
	}
	...
	public void testGetAtom() {
		...
		assertEquals("The getAtom method doesn't work properly", ATOM,
				lit.getAtom());
	}

	public void testEquals() {
		ObjectTests.runTestEquals(
	...
	public void testCompareTo() {
		ObjectTests.runTestCompareTo(
				new Literal(BASIC.createAtom(PREDICATE, TUPLE)), new Literal(
						BASIC.createAtom(PREDICATE, TUPLE)),
				new Literal(BASIC.createAtom(PREDICATE, TUPLEMORE)),
