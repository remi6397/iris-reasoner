...
* @date 13.12.2006 18:13:34
*/
public class ProjectionDescriptor extends Component implements IProjectionDescriptor{

	private int[] indexes = null;

	ProjectionDescriptor(int[] i) {
		super(ComponentType.PROJECTION);
		if (i == null) {
	...
	public String toString() {
		...
		buffer.append(ComponentType.PROJECTION);
		buffer.append(" [");
