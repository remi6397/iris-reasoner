...
public class JoinSimpleExtended implements IJoin{
	...
	private void setJoinOperator(IRelation arg0, IRelation arg1, int[] indexes){
		this.relation0 = arg0;
		this.relation1 = arg1;
	 ...
	 * regarding a specified tuple and perform the join operation using a helper
	 * method checkAndJoin0 or checkAndJoin1 (depending whether 
	 * relations0/relations1 is an outer/inner relation).
	 * 
	 * @param tuple
	 * @param order
	 * @return
