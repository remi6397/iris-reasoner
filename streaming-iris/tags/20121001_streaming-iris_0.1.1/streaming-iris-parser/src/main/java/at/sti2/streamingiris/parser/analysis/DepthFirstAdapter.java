...
package at.sti2.streamingiris.parser.analysis;
...
public class DepthFirstAdapter extends AnalysisAdapter
{
    ...
    public void inAPlainliteralTerm(APlainliteralTerm node)
    {
        defaultIn(node);
    }
    ...
    @Override
    public void caseAPlainliteralTerm(APlainliteralTerm node)
    {
        inAPlainliteralTerm(node);
        if(node.getTPrePlainliteral() != null)
        {
            node.getTPrePlainliteral().apply(this);
        }
        if(node.getTLpar() != null)
        {
            node.getTLpar().apply(this);
