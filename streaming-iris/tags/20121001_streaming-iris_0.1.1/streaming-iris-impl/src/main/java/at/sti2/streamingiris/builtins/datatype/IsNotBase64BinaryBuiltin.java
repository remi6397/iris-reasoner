 ...
 */
public class IsNotBase64BinaryBuiltin extends BooleanBuiltin {

	/** The predicate defining this built-in. */
	private static final IPredicate PREDICATE = at.sti2.streamingiris.factory.Factory.BASIC
			.createPredicate("IS_NOT_BASE64BINARY", 1);
	 ...
	 */
	public IsNotBase64BinaryBuiltin(ITerm... terms) {
		super(PREDICATE, terms);
	}

	protected boolean computeResult(ITerm[] terms) {
		return !IsBase64BinaryBuiltin.isBase64(terms[0]);
	}
