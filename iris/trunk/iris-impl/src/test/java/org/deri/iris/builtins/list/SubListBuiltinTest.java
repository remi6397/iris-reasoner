...
public class SubListBuiltinTest extends AbstractListBuiltinTest {

	private SubListBuiltin builtin;
	...
	public void testBuiltin() throws EvaluationException {
		...
		builtin = new SubListBuiltin(EMPTY_LIST, new IntTerm(0));
		//
