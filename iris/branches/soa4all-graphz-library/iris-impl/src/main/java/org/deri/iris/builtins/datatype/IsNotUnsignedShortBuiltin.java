 ...
 * @author Adrian Marte
 */
public class IsNotUnsignedShortBuiltin extends BooleanBuiltin {

	/** The predicate defining this built-in. */
	public static final IPredicate PREDICATE = BASIC.createPredicate(
			"IS_NOT_UNSIGNEDSHORT", 1);
	 ...
	 */
	public IsNotUnsignedShortBuiltin(ITerm... terms) {
		super(PREDICATE, terms);
	}

	protected boolean computeResult(ITerm[] terms) {
		return !IsUnsignedShortBuiltin.isUnsignedShort(terms[0]);
	}
