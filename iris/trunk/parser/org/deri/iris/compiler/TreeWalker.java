 ...
 * </p>
 * <p>
 * $Id: TreeWalker.java,v 1.15 2007-04-06 06:53:47 poettler_ric Exp $
 * </p>
...
public class TreeWalker extends DepthFirstAdapter {
	...
	if (builtinClass == null) { // this predicate is not a builtin
		...
		try {
			...
			System.err.println("Couldn't get the constructor for: " + builtinClass);
			throw new IllegalArgumentException(e);
		} catch (InstantiationException e) {
			System.err.println("Couldn't create the instance: " + builtinClass);
			throw new IllegalArgumentException(e);
