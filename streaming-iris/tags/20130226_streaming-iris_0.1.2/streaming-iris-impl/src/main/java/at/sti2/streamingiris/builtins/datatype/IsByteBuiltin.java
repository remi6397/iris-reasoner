 ...
 * @author Adrian Marte
 */
public class IsByteBuiltin extends BooleanBuiltin {

	/** The predicate defining this built-in. */
	public static final IPredicate PREDICATE = BASIC.createPredicate("IS_BYTE",
			1);
	 ...
	 */
	public IsByteBuiltin(ITerm... terms) {
