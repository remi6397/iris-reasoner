...
public class ListBuiltinHelper {
	...
	public static boolean isList(ITerm term) {
		...
		if (term instanceof at.sti2.streamingiris.api.terms.concrete.IList) {
			return true;
		}
		return false;
	}
	...
	public static boolean listContains(ITerm[] terms) {
		...
		IList list = (at.sti2.streamingiris.terms.concrete.List) terms[0];
	...
	public static int countList(ITerm term) {
		...
		IList list = (at.sti2.streamingiris.terms.concrete.List) term;
		return list.size();
	}
	...
	public static IList subList(ITerm[] terms) {
		...
		IList newList = new at.sti2.streamingiris.terms.concrete.List();
	...
	public static IList makeList(ITerm[] terms) {
		...
		IList list = new at.sti2.streamingiris.terms.concrete.List();
		for (int i = 0; i < terms.length; i++) {
			if (!(terms[i] instanceof IConcreteTerm)) {
				throw new IllegalArgumentException(
	...
	public static IList reverse(ITerm[] terms) {
		...
		IList list = new at.sti2.streamingiris.terms.concrete.List();
		list.addAll((IList) terms[0]);
		IList reverse_list = new at.sti2.streamingiris.terms.concrete.List();
		int i = list.size();
		while (!list.isEmpty()) {
	...
	public static IList indexof(ITerm[] terms) {
		...
		IList list2 = new at.sti2.streamingiris.terms.concrete.List();
	...
	public static IList distinct_values(ITerm term) {
		...
		return new at.sti2.streamingiris.terms.concrete.List(uniques);
	}
	...
	public static IList intersect(ITerm[] terms) {
		...
		IList list = new at.sti2.streamingiris.terms.concrete.List();
		list.addAll((IList) terms[0]);
		IList intersect_list = new at.sti2.streamingiris.terms.concrete.List();
		for (int i = 1; i < terms.length; i++) {
			if (!(terms[i] instanceof IList)) {
				throw new IllegalArgumentException("Arguments must be Lists.");
			}
			IList list_i = new at.sti2.streamingiris.terms.concrete.List();
	...
	public static IList except(ITerm[] terms) {
		...
		IList list_1 = new at.sti2.streamingiris.terms.concrete.List();
		list_1.addAll((IList) terms[0]);
		IList list_2 = new at.sti2.streamingiris.terms.concrete.List();
		list_2.addAll((IList) terms[1]);
		IList list_except = new at.sti2.streamingiris.terms.concrete.List();
		for (ITerm t : list_1) {
