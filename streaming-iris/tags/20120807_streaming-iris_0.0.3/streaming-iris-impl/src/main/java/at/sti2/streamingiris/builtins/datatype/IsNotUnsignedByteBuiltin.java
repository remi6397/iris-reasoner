 ...
 * @author Adrian Marte
 */
public class IsNotUnsignedByteBuiltin extends BooleanBuiltin {

	/** The predicate defining this built-in. */
	public static final IPredicate PREDICATE = BASIC.createPredicate(
			"IS_NOT_UNSIGNEDBYTE", 1);
	 ...
	 */
	public IsNotUnsignedByteBuiltin(ITerm... terms) {
		super(PREDICATE, terms);
	}

	protected boolean computeResult(ITerm[] terms) {
		return !IsUnsignedByteBuiltin.isUnsignedByte(terms[0]);
	}
